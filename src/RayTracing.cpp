...
hittable_list earth()
{
    ...
    auto earth_suface = std::make_shared<lambertian>(earth_texture);
    auto globe = std::make_shared<sphere>(point3(0, 0, 0), 2, earth_suface);
...
hittable_list final_scene()
{
    ...
    auto mirror = std::make_shared<dielectric>(0.5);
    boxes1.add(std::make_shared<xy_rect>(-1000, 1000, 0, 1000, 1000, mirror));
